...
Notification.requestPermission().then((permission) => {
  if (permission === 'granted') {
    getToken(messaging, {
      vapidKey:
        'BNKN0pwkjFZEh4xfPWH8_tmmEFzeJYo6bFcE8peRGp3duEr0c8eFDuU4kMAo8asd15Z_arIBej6oS9UJoAcObF4'
    })
      .then((currentToken) => {
        if (currentToken) {
...
<!-- cd C:\Program Files\Google\Chrome\Application\ -> chrome.exe --ignore-certificate-errors --unsafely-treat-insecure-origin-as-secure=https://localhost:5173 --user-data-dir=C:\tmp -->
